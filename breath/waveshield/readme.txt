...
Try daphc.pde in the examples folder.  If you have problems run the
SdReadTest.pde sketch to get more information.
...
statement in a sketch to 'card.init(true)'.  'true' means initialize
the card at a slower speed.
...
I have included several updates examples for WaveHC in the examples 
