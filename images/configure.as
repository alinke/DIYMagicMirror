package {
	...
	public function configure():void {
		...
		if (Number(myXML.version) < 6.0) {  //this means user's config file was old and needs to be updated but we'll also save the user's settings so they don't have to re-type
	...
	private function BuildMainUI():void { //one time initial
		...
		TTSTextFormat.color = 0x000000; //blue	
		...
		positioningedit_radio_weatherImage.x = 750;
		...
		positioningedit_radio_webcamImage.x = 750;
		...
		positioningedit_radio_beerImage.x = 750;
		...
		positioningedit_radio_lipsync.x = 750;
		...
		switch (board_version_temp)  //sets the video playlists based on the mode
				...
				case "5": 
					...
					break;		
				default:
					board_version_input.selectedIndex = 3;
					arduino_version_input.selectedIndex = 1;
				}
   ...
   private function RefreshAlbums(evt : PicasaDataEvent) : void
	{
		var drop : Object;	
...
<mirror>
  ...
  <alcohol_no_switch>on</alcohol_no_switch>
  <alcohol_no_switch_interval>500</alcohol_no_switch_interval>
  ...
  <alcohol_level3>600</alcohol_level3>
  <alcohol_countdown>6</alcohol_countdown>
  ...
  <alcohol_results_text_x>500</alcohol_results_text_x>
  <alcohol_results_text_y>100</alcohol_results_text_y>
  ...
  <twitter_consumerKey>xyI9XYpCuz5gjfxzlWyPwA</twitter_consumerKey>
  <twitter_consumerSecret>8YZSrYeTS3gNMgPat1U0RsGK7pqNUBN3ggIHp7hBR8</twitter_consumerSecret>
  ...
  <branding>DIY</branding>
	...
	private function saveValues():void {
		...
		myXML.beer_image_sclae = beer_image_scale;		
